...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(App, null), document.getElementById('appWrapper'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	/** @jsx React.DOM */var React = __webpack_require__(148);
	var Title = __webpack_require__(149);
	var HeroHover = __webpack_require__(150);
	var HeroGrid = __webpack_require__(151);
	var HeroSelector = __webpack_require__(156);
	  ...
	  render:function () {
	    return (
	      React.createElement("div", null, 
	        ...
	        React.createElement(HeroSelector, {
	        ...
	        React.createElement(HeroHover, {heroMouseOver: this.state.heroMouseOver}), 
	        React.createElement(HeroGrid, {
	          displayGrid: this.state.displayGrid, 
	          counterStates: this.state.counterStates, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HeroHover = React.createClass({displayName: "HeroHover",
	  propTypes: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/** @jsx React.DOM */var React = __webpack_require__(148);
	var mapHeroes = __webpack_require__(152);
	var heroNames = __webpack_require__(155);

	var HeroGrid = React.createClass({displayName: "HeroGrid",
	  propTypes: {
	  ...
	  render:function () {
	    if (this.props.displayGrid) {
	      ...
	      return (
	        React.createElement("div", {className: "heroGridWrapper"}, 
	          React.createElement("div", {className: "strHeroes"}, 
	            React.createElement("h3", {className: "strHeader"}, "Strength"), 
	            React.createElement("table", {className: "radiantStrHeroes"}, 
	              React.createElement("tbody", null, radiantStrRows)
	            ), 
	            React.createElement("table", {className: "direStrHeroes"}, 
	              React.createElement("tbody", null, direStrRows)
	            )
	          ), 
	          React.createElement("div", {className: "agiHeroes"}, 
	            React.createElement("h3", {className: "agiHeader"}, "Agility"), 
	            React.createElement("table", {className: "radiantAgiHeroes"}, 
	              React.createElement("tbody", null, radiantAgiRows)
	            ), 
	            React.createElement("table", {className: "direAgiHeroes"}, 
	              React.createElement("tbody", null, direAgiRows)
	            )
	          ), 
	          React.createElement("div", {className: "intHeroes"}, 
	            React.createElement("h3", {className: "intHeader"}, "Intelligence"), 
	            React.createElement("table", {className: "radiantIntHeroes"}, 
	              React.createElement("tbody", null, radiantIntRows)
	            ), 
	            React.createElement("table", {className: "direIntHeroes"}, 
	              React.createElement("tbody", null, direIntRows)
	            )
	          )
	        )
	      );
	      ...
	      return (
	        React.createElement("div", {className: "heroGridWrapper"}, 
	          React.createElement("div", {className: "strHeroes"}, 
	            React.createElement("h3", {className: "strHeader"}, "Great Counters"), 
	            React.createElement("table", {className: "radiantStrHeroes"}, 
	              React.createElement("tbody", null, greatCounters)
	            )
	          ), 
	          React.createElement("div", {className: "agiHeroes"}, 
	            React.createElement("h3", {className: "agiHeader"}, "Good Counters"), 
	            React.createElement("table", {className: "radiantAgiHeroes"}, 
	              React.createElement("tbody", null, counters)
	            )
	          ), 
	          React.createElement("div", {className: "intHeroes"}, 
	            React.createElement("h3", {className: "intHeader"}, "Avoid"), 
	            React.createElement("table", {className: "radiantIntHeroes"}, 
	              React.createElement("tbody", null, avoid)
	            )
	          )
	        )
	      );
...
/***/ function(module, exports, __webpack_require__) {
	...
	/** @jsx React.DOM */var React = __webpack_require__(148);
	var generateClasses = __webpack_require__(153);
	var heroNames = __webpack_require__(155);
	...
	exports.generateSelectGrid = function(data, context) {
	  var result = data.map(function (row, index) {
	      ...
	      return (
	        React.createElement("tr", {key: index}, heroes)
	      );
	    }, context)
	  return result;
	};
	...
	exports.generateResultsGrid = function(data, context) {
	  ...
	  for (var i = 0; i < tds.length; i++) {
	    ...
	    if (row.length === 4 || i === tds.length - 1)  {
	      result.push(React.createElement("tr", null, row));
	      row = [];
	    }
	  }
	  return result;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cx = __webpack_require__(154);
	var heroNames = __webpack_require__(155);
	    ...
	    return (
	      React.createElement("div", {className: "heroSelectorWrapper"}, 
	        ...
	        React.createElement("div", {className: "buttonWrapper"}, 
	          React.createElement("div", {className: submitHeroesClasses, onMouseEnter: this.props.handleButtonMouseEnter.bind(null, 'submitHeroes'), onMouseLeave: this.props.handleButtonMouseLeave.bind(null, 'submitHeroes'), onClick: this.props.handleSubmitClick}, React.createElement("span", {className: "submitHeroesLabel"}, this.props.displayGrid ? 'Submit' : 'Back')), 
	          React.createElement("div", {className: clearHeroesClasses, onMouseEnter: this.props.handleButtonMouseEnter.bind(null, 'clearHeroes'), onMouseLeave: this.props.handleButtonMouseLeave.bind(null, 'clearHeroes'), onClick: this.props.handleClearClick}, React.createElement("span", {className: "clearHeroesLabel"}, "Clear"))
	        )
	      )
	    )
	  }
